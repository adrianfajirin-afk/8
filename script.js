/* =====================================================================
   ...
   3) GAMBAR BINGKAI FOTO (frame)
      ...
      - Ukuran gambar PNG persis: frame-1.png = 300x560, frame-2.png =
        300x480, frame-3.png = 300x420 (lebar x tinggi, dalam pixel).
      - Sisakan ruang kosong ±96px di bagian bawah untuk teks nama &
...
const state = {
  ...
  frames: [
    { id:'a', label:'Merah Klasik', slots:3, image:'img/frame-1.png', bg:'#f6ece0', accent:'#8a2530',
      slotRects: [ {x:24,y:54,w:252,h:127}, {x:24,y:195,w:252,h:127}, {x:24,y:336,w:252,h:127} ] },
    { id:'b', label:'Mawar Senja',  slots:2, image:'img/frame-2.png', bg:'#fbeee0', accent:'#c9743a',
      slotRects: [ {x:24,y:54,w:252,h:158}, {x:24,y:226,w:252,h:158} ] },
    { id:'c', label:'Taman Hijau',  slots:1, image:'img/frame-3.png', bg:'#f3f0e6', accent:'#5c7048',
      slotRects: [ {x:24,y:54,w:252,h:270} ] },
  ],
  frameIndex: 0,
  photos: [],
  currentSlot: 0,
