...
function buildFeedPost(item){
  ...
  // Ikon berubah jadi animasi "gelombang suara" selagi VN diputer, mirip
  // animasi rekam VN di awal (mic-btn/rec-wave), lalu balik ke ikon mic
  // diam begitu VN di-pause/selesai.
  if(hasRealVn){
    ...
    vnBtn.innerHTML = `
      <svg class="ig-vn-icon" viewBox="0 0 24 24"><path d="M12 14a3 3 0 0 0 3-3V6a3 3 0 0 0-6 0v5a3 3 0 0 0 3 3zm5-3a5 5 0 0 1-10 0H5a7 7 0 0 0 6 6.92V21h2v-3.08A7 7 0 0 0 19 11h-2z"/></svg>
      <span class="ig-vn-bars"><span></span><span></span><span></span><span></span></span>`;
    actions.appendChild(vnBtn);

    const stopThisVn = function(){
      if(vnAudioEl) vnAudioEl.pause();
      vnBtn.classList.remove('playing');
    };
    ...
    vnBtn.addEventListener('click', function(ev){
      ...
      if(!vnAudioEl){
        ...
        vnAudioEl.addEventListener('ended', function(){ vnBtn.classList.remove('playing'); });
